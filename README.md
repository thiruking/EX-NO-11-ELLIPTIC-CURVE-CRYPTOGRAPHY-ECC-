...
int main() {
    ...
    printf("Enter Thiru's private key: ");
    scanf("%lld", &privateA);
    printf("Enter San's private key: ");
    scanf("%lld", &privateB);
    ...
    printf("Thiru's public key: (%lld, %lld)\n", publicA.x, publicA.y);
    printf("San's public key: (%lld, %lld)\n", publicB.x, publicB.y);
    ...
    printf("Shared secret computed by Thiru: (%lld, %lld)\n", sharedSecretA.x, sharedSecretA.y);
    printf("Shared secret computed by San: (%lld, %lld)\n", sharedSecretB.x, sharedSecretB.y);
...
## Output:
<img width="821" height="447" alt="image" src="https://github.com/user-attachments/assets/42b4cad9-6f01-4fcd-a126-fb0b878895bc" />
